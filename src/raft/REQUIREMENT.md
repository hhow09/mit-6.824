...
If you have done Lab 1, you already have a copy of the lab source code. If not, you can find directions for obtaining the source via git in the [Lab 1 instructions](http://nil.csail.mit.edu/6.824/2021/labs/lab-mr.html).
...
### Part 2A: leader election ([moderate](http://nil.csail.mit.edu/6.824/2021/labs/guidance.html))
...
- Hint: You may find Go's [rand](https://golang.org/pkg/math/rand/) useful.
- Hint: You'll need to write code that takes actions periodically or after delays in time. The easiest way to do this is to create a goroutine with a loop that calls [time.Sleep()](https://golang.org/pkg/time/#Sleep); (see the ticker() goroutine that Make() creates for this purpose). Don't use Go's time.Timer or time.Ticker, which are difficult to use correctly.
- Hint: The [Guidance page](http://nil.csail.mit.edu/6.824/2021/labs/guidance.html) has some tips on how to develop and debug your code.
...
$ go test -run 2A -race
Test (2A): initial election ...
  ... Passed -- Hint: 4.0  3   32    9170    0
Test (2A): election after network failure ...
  ... Passed -- Hint: 6.1  3   70   13895    0
PASS
ok      raft    10.187s
$
```
...
- Hint: Do yourself a favor for future labs and write (or re-write) code that's clean and clear. For ideas, re-visit our the [Guidance page](http://nil.csail.mit.edu/6.824/2021/labs/guidance.html) with tips on how to develop and debug your code.
- Hint: If you fail a test, look over the code for the test in config.go and test\_test.go to get a better understanding what the test is testing. config.go also illustrates how the tester uses the Raft API.
...
Test (2B): basic agreement ...
  ... Passed -- Hint: 1.6  3   18    5158    3
Test (2B): RPC byte count ...
  ... Passed -- Hint: 3.3  3   50  115122   11
Test (2B): agreement despite follower disconnection ...
  ... Passed -- Hint: 6.3  3   64   17489    7
Test (2B): no agreement if too many followers disconnect ...
  ... Passed -- Hint: 4.9  5  116   27838    3
Test (2B): concurrent Start()s ...
  ... Passed -- Hint: 2.1  3   16    4648    6
Test (2B): rejoin of partitioned leader ...
  ... Passed -- Hint: 8.1  3  111   26996    4
Test (2B): leader backs up quickly over incorrect follower logs ...
  ... Passed --  28.6  5 1342  953354  102
Test (2B): RPC counts aren't too high ...
  ... Passed -- Hint: 3.4  3   30    9050   12
PASS
ok      raft    58.142s
...
- Hint: You will probably need the optimization that backs up nextIndex by more than one entry at a time. Look at the [extended Raft paper](http://nil.csail.mit.edu/6.824/2021/papers/raft-extended.pdf) starting at the bottom of page 7 and top of page 8 (marked by a gray line). The paper is vague about the details; you will need to fill in the gaps, perhaps with the help of the 6.824 Raft lectures.
...
Test (2C): basic persistence ...
  ... Passed -- Hint: 7.2  3  206   42208    6
Test (2C): more persistence ...
  ... Passed --  23.2  5 1194  198270   16
Test (2C): partitioned leader and one follower crash, leader restarts ...
  ... Passed -- Hint: 3.2  3   46   10638    4
Test (2C): Figure 8 ...
  ... Passed --  35.1  5 9395 1939183   25
Test (2C): unreliable agreement ...
  ... Passed -- Hint: 4.2  5  244   85259  246
...
- Hint: Snapshot(index int, snapshot \[\]byte)
- Hint: CondInstallSnapshot(lastIncludedTerm int, lastIncludedIndex int, snapshot \[\]byte) bool
...
Note that InstallSnapshot RPCs are sent _between_ Raft peers, whereas the provided skeleton functions Snapshot/CondInstallSnapshot are used by the service to communicate to Raft.
