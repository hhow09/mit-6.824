...
for i in $(seq 1 $TIMES); do
  ...
  VERBOSE=1 go test ./kvraft/... -race -run="(TestSnapshotRPC3B|TestSnapshotSize3B|TestSpeed3B|TestSnapshotRecover3B|TestSnapshotRecoverManyClients3B|TestSnapshotUnreliable3B|TestSnapshotUnreliableRecover3B)" -count=1
done
